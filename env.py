...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_obstacle6 = Image.open("images/road_closed3.png")
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        ...
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 3, pixels * 5, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        ...
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 4, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 5, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 6, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 4, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 8, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        ...
        self.flag = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.flag_object)
